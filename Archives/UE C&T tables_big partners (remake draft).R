...
#join datasets together 
    ...
    df_ue<-df_ue%>%
     ...
     df_ue<-df_ue%>%select(countryname,mech_code, mech_name, primepartner,program, indicator, unit_expenditure, cumulative)%>%
      ...
      df_ue<-df_ue%>%
         select(countryname,mech_code, mech_name, primepartner,cumulative_HTS_TST,cumulative_HTS_TST_POS,
        ...
        df_ue<-df_ue%>%     group_by(countryname,mech_code, mech_name, primepartner,)%>%
...
# testing ============================================================================
    ...
    get_ue_partner(df_ue, "Abt Associates Inc.")%>%
